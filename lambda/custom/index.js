...
const globalHandlers = {
    'GlobalHelpHandler': function() {
        ...
        if (this.attributes.isRollCallComplete === true) {
            ...
            reprompt = "To continue, pick a color: red, blue, or green. " 
                     + " Or say cancel or exit to quit. ";
            outputSpeech = "Now that we each have a button, you can select a color " 
                        + " for me to challenge you. "
                        + "Select one of the following colors: red, blue, or green. " 
                        + "I will display a shade of your color of choice "
                        + "and wait for you to match it on your button. "
            ...
            outputSpeech = "You will need two Echo buttons to play this game. "
                        + "Each of the two buttons you plan to use "
                        + "must be pressed in turn, to be added to the game. "
